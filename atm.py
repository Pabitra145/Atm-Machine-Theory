#atm machine programming by gangster sittu
import getpass
import string
import os
...
while count < 3:
	...
	if pin.isdigit():
		...
		print('------------------------')
		print('************************')
		print('Chitti SAYS PIN CONSISTS OF 4 DIGITS')
		print('************************')
		print('------------------------')
		count += 1
...
print('-------------------------')
print('*************************')
print('Hey! LOGIN SUCCESFUL, CONTINUE')
print('*************************')
print('-------------------------')
print()
print('--------------------------')
print('**************************')	
print(str.capitalize(users[n]), 'welcome to JS ATM')
print('**************************')
print('----------JS ATM SYSTEM-----------')
# Main menu
while True:
	...
	print('-------------------------------')
	print('*******************************')
	response = input('SELECT FROM FOLLOWING OPTIONS JS ATM : \nStatement__(S) \nWithdraw___(W) \nLodgement__(L)  \nChange PIN_(P)  \nQuit_______(Q) \n: ').lower()
	print('*******************************')
	print('-------------------------------')
